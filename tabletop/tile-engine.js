...
(function (root) {
  ...
  const PATH = { NONE:0, ROAD:1, TRAIL:2, RIVER:3, WALL:4, RAIL:5, HWY:6 };      // RAIL = railway · HWY = elevated highway (Modern Pack)
  const PATH_NAME = ['none','road','trail','river','wall','rail','highway'];
  const PATH_COLOR = { none:0x000000, road:0xC9A24B, trail:0x8a6a44, river:0x3d7fb0, wall:0x8b8b93, rail:0x5a5048, highway:0x3a3c40 };
  ...
  const BIOME = { PLAINS:'plains', VILLAGE:'village', CITY:'city', FOREST:'forest', MOUNTAINS:'mountains', WATER:'water', SNOW:'snow', ROCKS:'rocks',
    ...
    URBAN:'urban', SUBURB:'suburb', LOT:'lot', PARK:'park', INDUSTRIAL:'industrial', BEACH:'beach' };   // MODERN PACK: city pavement · suburban lawn lots · asphalt parking · parkland   // sand = desert dune; town-ground bases: cobble plaza, packed dirt, town green; farmland: crop rows, fruit-tree orchard, centre-pivot circle
  const BIOME_COLOR = {
    ...
    urban:0x9c9ea3, suburb:0x7fa44e, lot:0x4a4c50, park:0x6f9a45, industrial:0x8c8b86, beach:0xe8d9a8
  };
  ...
  const NATURAL = new Set([
    ...
    ...['urban','suburb','lot','park','industrial','beach'].flatMap(m=>['plains','forest','water','rocks','sand','green','dirt','crops','orchard','pivot','village','city','plaza','urban','suburb','lot','park','industrial','beach'].filter(o=>o!==m).map(o=>m+'|'+o)),
